...
%Since smart contract can not be altered after it is deployed on blockchain. 
%
...
To achieve our idea, our system should contain following four parts at least:%which can be seen from Fig. \ref{workflow}.
\begin{itemize}
