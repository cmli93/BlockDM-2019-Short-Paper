...
\begin{document}
	...
	%refer the notaability hints about writing a paper
...
\author{\IEEEauthorblockN{Chunmiao Li}
\IEEEauthorblockA{Department of Informatics, SOKENDAI \\
	(Also, National Institute of Informatics) \\
chunmiaoli1993@nii.ac.jp}
\and
\IEEEauthorblockN{Yang Cao}
\IEEEauthorblockA{Department of Social Informatics, Kyoto University \\
yang@i.kyoto-u.ac.jp}
\and
\IEEEauthorblockN{Zhenjiang Hu}
\IEEEauthorblockA{ Department of Informatics, SOKENDAI \\
	(Also, National Institute of Informatics) \\
hu@nii.ac.jp}
\and
...
Thanks for the suggestions from Josh Ko.
